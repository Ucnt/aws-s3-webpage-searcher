...
class ProgressBar(object):
    def __init__(self, num_items):
        ...
        self.cur_item = 0
        self.items_per_sec = 0
        self.per_sec_label = "/sec"
    ...
    def __call__(self, num_completed=1):
        ...
        self.items_per_sec = int(self.cur_item / run_time)
        ...
        args = {
            ...
            'items_per_sec': "{items_per_sec}".format(items_per_sec=self.items_per_sec),
